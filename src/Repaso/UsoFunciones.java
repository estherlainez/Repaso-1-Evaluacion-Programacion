	...
	public static void main(String[] args) {
		...
		do {
			...
			case 2: 
				...
				System.out.println("El menor primo y mayor que el numero es: "+menorPrimo);
				break;
			case 3: 
			...
			case 6: 
				...
				break;
			default: 
				System.out.println("Debes introducir un numero entre el 0 y el 6");
			}			
		}while(n!=6);		
		teclado.close();	
	}
